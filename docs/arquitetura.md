...
- **`gege-crm/`** — **Repo separado:** [github.com/giselysilvestre/gege-crm](https://github.com/giselysilvestre/gege-crm) — CRM WhatsApp (Conversas, funil, ações). Mesmo Supabase e Kapso; deploy próprio na Vercel.
...
4. **Currículo** — Processador extrai texto do PDF, chama Claude com o prompt **compact** oficial (`prompt-cv-gege.js`), persiste análise e experiências.
