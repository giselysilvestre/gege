...
Índice da documentação do projeto (complementa o [README principal](../README.md)).

| Documento | Conteúdo |
|-----------|-----------|
| [banco-de-dados.md](./banco-de-dados.md) | Schema PostgreSQL/Supabase: tabelas, views, storage, enums, RLS (visão geral). |
| [prompt-avaliacao-candidato.md](./prompt-avaliacao-candidato.md) | Prompt do Claude no processador de CV, tags derivadas e score de match no app. |
