/**
 * Cópia de shared/score-final.js — fórmula idêntica (0.5/0.5), manter em sync.
 * Duplicada aqui porque o build do Railway (rootDirectory=whatsapp-bot) não acessa shared/.
 *
