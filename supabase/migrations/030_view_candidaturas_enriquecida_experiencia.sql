-- Enriquece a view de listagens com campos de experiência do candidato (evita dados sempre nulos no app).
...
select
  ...
  c.exp_total_meses,
  c.exp_instabilidade_pct,
  c.exp_alimentacao_meses,
  c.exp_atendimento_meses,
  c.exp_cozinha_meses,
  c.exp_lideranca_meses,
  c.exp_total_empregos,
  c.exp_resumo
